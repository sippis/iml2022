...
### Lasso for reduced sets of variables
```{r lasso2}
lasso2<-cv.glmnet(x=as.matrix(npf.168[,1:36]),y=class2, alpha=1,family="binomial", type.measure="class")
lasso3<-cv.glmnet(x=as.matrix(npfsp[,1:18]),y=class2, alpha=1,family="binomial", type.measure="class")
lassopc1<-cv.glmnet(x=x1,y=class2, alpha=1,family="binomial", type.measure="class")
lassopc2<-cv.glmnet(x=x2,y=class2, alpha=1,family="binomial", type.measure="class")
lassopc3<-cv.glmnet(x=x3,y=class2, alpha=1,family="binomial", type.measure="class")
plot(lasso2)
plot(lasso3)
plot(lassopc1)
plot(lassopc2)
