...
We made the decision based on preliminary results, and though decision trees would represent an equally viable solution, we calculated those results only later on, and by that point had already calculated the results for the logistic regression model. However, for the final report we might consider transitioning to the decision tree model.
