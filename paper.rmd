...
In our modeling, we used the function lda from the package MASS[@MASS]. We tested the performance of the model on the dataset with observations measured at multiples only observed at 16.8 meters.
...
In our approach, we used the qda function from the MASS[@MASS] package, and as with linear discriminant analysis, tested the performance of the model on the dataset with observations measured at multiples only observed at 16.8 meters.
...
We used the naiveBayes function from the package e1071[@e1071] and the original dataset.
